...
"""Example of how to extend the search list used by the Cheetah template engine.
...
To use it, modify the option search_list in your skin.conf configuration file, adding
the name of the extension to the end of the list. For this example, the name of
the extension is examples.xsearch.MyXSearch. So, when you're done, it will look something
like this:

[CheetahGenerator]
    search_list = weewx.cheetahgenerator.Almanac, weewx.cheetahgenerator.Station, weewx.cheetahgenerator.Stats, weewx.cheetahgenerator.UnitInfo, weewx.cheetahgenerator.Extras, weewx.cheetahgenerator.Current, examples.xsearch.MyXSearch

Note that if your file skin.conf is from an older version of Weewx, this section may
be named [FileGenerator]. It will work just fine.
