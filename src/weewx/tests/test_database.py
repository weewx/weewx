...
class Common:
    ...
    def populate_database(self):
        ...
        with weewx.manager.Manager.open_with_create(self.archive_db_dict,
    ...
    def test_open_no_archive(self):
        ...
        with pytest.raises(weedb.NoDatabaseError):
            weewx.manager.Manager.open(self.archive_db_dict)
    ...
    def test_create_archive(self):
        ...
        archive = weewx.manager.Manager.open_with_create(self.archive_db_dict,
    ...
    def test_add_archive_records(self):
        ...
        with weewx.manager.Manager.open(self.archive_db_dict) as archive:
            ...
            for _rec in archive.genBatchRecords():
                ...
                assert _rec.pop('windSpeed') is None
                assert _expected_rec == _rec
    ...
    def test_get_records(self):
        ...
        with weewx.manager.Manager.open(self.archive_db_dict) as archive:
            ...
            # Check that the missing windSpeed is None, then remove it in order to do the compare:
            assert _rec.pop('windSpeed') is None
            assert expected_record(itest) == _rec
