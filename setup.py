...
if __name__ == "__main__":
    ...
    setup(name='weewx',
          ...
          data_files=[
                      ...
                      ('extensions/pmon/bin/user',
                       ['extensions/pmon/bin/user/pmon.py']),
                      ('extensions/pmon/skins/pmon',
                      ...
                      ('extensions/xstats/bin/user',
                       ['extensions/xstats/bin/user/xstats.py']),
                      ('extensions/xstats/skins/xstats',
