    ...
    setup(name='weewx',
          ...
          data_files=[
              ...
              ('skins/Smartphone/lang',
               ['skins/Smartphone/lang/de.conf',
                'skins/Smartphone/lang/en.conf',
                'skins/Smartphone/lang/nl.conf',
                'skins/Smartphone/lang/no.conf']),
              ('skins/Seasons',
              ...
              ('skins/Seasons/font',
               ['skins/Seasons/font/OpenSans.woff',
                ...
                'skins/Seasons/font/Kanit-Bold.ttf',
                'skins/Seasons/font/Kanit-Regular.ttf',
                'skins/Seasons/font/OFL.txt',
                'skins/Seasons/font/OpenSans-Bold.ttf',
                'skins/Seasons/font/OpenSans-Regular.ttf',
                'skins/Seasons/font/license.txt']),
              ('skins/Seasons/NOAA',
               ['skins/Seasons/NOAA/NOAA-%Y-%m.txt.tmpl',
                'skins/Seasons/NOAA/NOAA-%Y.txt.tmpl']),
              ('skins/Seasons/lang',
               ['skins/Seasons/lang/cn.conf',
                'skins/Seasons/lang/cz.conf',
                'skins/Seasons/lang/de.conf',
                'skins/Seasons/lang/en.conf',
                'skins/Seasons/lang/es.conf',
                'skins/Seasons/lang/fr.conf',
                'skins/Seasons/lang/gr.conf',
                'skins/Seasons/lang/it.conf',
                'skins/Seasons/lang/nl.conf',
                'skins/Seasons/lang/no.conf',
                'skins/Seasons/lang/th.conf']),
              ('skins/Mobile',
               ['skins/Mobile',
              ...
              ('skins/Mobile/lang',
               ['skins/Mobile/lang/de.conf',
                'skins/Mobile/lang/en.conf',
                'skins/Mobile/lang/nl.conf',
                'skins/Mobile/lang/no.conf']),
              ('skins/Standard',
              ...
              ('skins/Standard/NOAA',
               ['skins/Standard/NOAA/NOAA-%Y-%m.txt.tmpl',
                'skins/Standard/NOAA/NOAA-%Y.txt.tmpl']),
              ('skins/Standard/lang',
               ['skins/Standard/lang/de.conf',
                'skins/Standard/lang/en.conf',
                'skins/Standard/lang/fr.conf',
                'skins/Standard/lang/nl.conf',
                'skins/Standard/lang/no.conf']),
              ('util/apache/conf.d',
              ...
              ('util/systemd',
               ['util/systemd/weewx.service-redhat',
			   'util/systemd/weewx.service-suse']),
              ('util/udev/rules.d',
