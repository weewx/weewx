          ...
          data_files=[
            ...
            ('docs/examples',
             ['docs/examples/tag.htm',
              'docs/examples/alarm.py',
              'docs/examples/lowBattery.py',
              'docs/examples/mem.py',
              'docs/examples/stats.py',
              'docs/examples/transfer_db.py']),
            ('docs/examples/basic',
             ['docs/examples/basic/changelog',
              'docs/examples/basic/install.py',
              'docs/examples/basic/readme.txt']),
            ('docs/examples/basic/skins/basic',
             ['docs/examples/basic/skins/basic/basic.css',
              'docs/examples/basic/skins/basic/current.inc',
              'docs/examples/basic/skins/basic/favicon.ico',
              'docs/examples/basic/skins/basic/hilo.inc',
              'docs/examples/basic/skins/basic/index.html.tmpl',
              'docs/examples/basic/skins/basic/skin.conf']),
            ('docs/examples/fileparse',
             ['docs/examples/fileparse/changelog',
              'docs/examples/fileparse/install.py',
              'docs/examples/fileparse/readme.txt']),
            ('docs/examples/fileparse/bin/user',
             ['docs/examples/fileparse/bin/user/fileparse.py']),
            ('docs/examples/pmon',
             ['docs/examples/pmon/changelog',
              'docs/examples/pmon/install.py',
              'docs/examples/pmon/readme.txt']),
            ('docs/examples/pmon/bin/user',
             ['docs/examples/pmon/bin/user/pmon.py']),
            ('docs/examples/pmon/skins/pmon',
             ['docs/examples/pmon/skins/pmon/index.html.tmpl',
              'docs/examples/pmon/skins/pmon/skin.conf']),
            ('docs/examples/xstats',
             ['docs/examples/xstats/changelog',
              'docs/examples/xstats/install.py',
              'docs/examples/xstats/readme.txt']),
            ('docs/examples/xstats/bin/user',
             ['docs/examples/xstats/bin/user/xstats.py']),
            ('docs/examples/xstats/skins/xstats',
             ['docs/examples/xstats/skins/xstats/index.html.tmpl',
              'docs/examples/xstats/skins/xstats/skin.conf']),
            ('skins/Ftp',
             ['skins/Ftp/skin.conf']),
            ('skins/Rsync',
