...
There are three methods to upgrade WeeWX:

* [Upgrading using pip](../pip)
* [Upgrading using DEB package](../deb)
* [Upgrading using RPM package](../rpm)
...
The rest of this document describes the changes in each version of WeeWX.
