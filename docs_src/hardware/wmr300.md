# WMR300
        ...
        <p>The rain counter has a limit of 400 inches (10160 mm).  The
            counter does not wrap around; it must be reset when it hits
            the limit, otherwise additional rain data will not be recorded.
        </p>

        <p>The logger stores about 50,000 records.  When the logger fills
            up, it stops recording data.</p>
