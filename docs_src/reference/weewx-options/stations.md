...
!!! note
    ...
    section is by using the utility [`weectl station reconfigure`](../../../utilities/weectl-station/#reconfigure-an-existing-station).
...
opt into the [station registry](../stdrestful/#stationregistry), it will also
...
See the [CC3000 Station data table](../../../hardware/cc3000/#cc3000_data)
...
See the [*TE923*](../../../hardware/te923) section of the *Hardware Guide*
...
See the [*WMR100*](../../../hardware/wmr100) section of the *Hardware guide*
...
See the [*WMR300*](../../../hardware/wmr300) section of the *Hardware guide*
for a complete listing of sensor names and the default database fields for
each sensor.
...
See the [*WMR9x8*](../../../hardware/wmr9x8) sectioin of the *Hardware guide*
for a complete listing of sensor names and the default database fields for
each sensor.
